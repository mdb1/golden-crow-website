    ...
    <tbody>
      <tr>
        ...
        <td valign="top" style="width: 219px; padding: 0 0 0 12px;">
          <div style="margin: 0; font-size: 16px; line-height: 18px; font-weight: 700; color: #252630;">Federico Bustos Fierro</div>
          <div style="margin: 0 0 5px 0; font-size: 11px; line-height: 13px; color: #98712d;">Co-founder</div>
          <div style="margin: 0 0 3px 0; font-size: 12px; line-height: 15px; color: #252630;">Golden Crow Venture Studio</div>
          <table cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: collapse; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 14px; color: #252630;">
            <tbody>
              <tr>
                ...
                <td style="padding: 0 0 2px 0;"><a href="mailto:federico@goldencrowvs.com" style="color: #252630; text-decoration: none;">federico@goldencrowvs.com</a></td>
              </tr>
              <tr>
                ...
                <td style="padding: 0 0 2px 0;"><a href="tel:+5491121846934" style="color: #252630; text-decoration: none;">+54 9 11 2184-6934</a></td>
              </tr>
              <tr>
      ...
      <tr>
        ...
        <td valign="top" style="width: 219px; padding: 7px 0 0 12px;">
          <div style="border-top: 1px solid #dcd6cb; padding-top: 7px; font-size: 11px; line-height: 14px; color: #656570;">Soluciones digitales para gen&oacute;mica<br>y medicina de precisi&oacute;n.</div>
        </td>
      </tr>
    </tbody>
  </table>
