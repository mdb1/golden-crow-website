...
const TwoPQPatientInformationSchema = z.object({
  ...
  partnerMedicalRecordNumber: z.string().optional(),
...
const TwoPQMedicalInformationSchema = z.object({
  ...
  spermGameteSource: z.string().optional(),
  oocyteGameteSource: z.string().optional(),
...
const TwoPQPreviousGeneticTestsSchema = z.object({
  ...
  karyotypeFileName: z.string().optional(),
  karyotypeFileType: z.string().optional(),
  karyotypeFileSize: z.union([z.number(), z.string()]).optional(),
  karyotypeFileContent: z.string().optional(),
...
const TwoPQRequestedTestSchema = z.object({
  pgtAFast: TwoPQBooleanAnswerSchema.optional(),
  pgtAFastReportsMosaicism: TwoPQBooleanAnswerSchema.optional(),
  pgtAFastReportsSex: TwoPQBooleanAnswerSchema.optional(),
  pgtAStandard: TwoPQBooleanAnswerSchema.optional(),
  pgtAStandardReportsMosaicism: TwoPQBooleanAnswerSchema.optional(),
  pgtAStandardReportsSex: TwoPQBooleanAnswerSchema.optional(),
  pgtA: TwoPQBooleanAnswerSchema.optional(),
  pgtSr: TwoPQBooleanAnswerSchema.optional(),
  pgtSrReportsMosaicism: TwoPQBooleanAnswerSchema.optional(),
  pgtSrReportsSex: TwoPQBooleanAnswerSchema.optional(),
...
const TwoPQSampleInformationSchema = z.object({
  ...
  requestingDoctorFullName: z.string().optional(),
  requestingDoctorAuthEmail: z.string().optional(),
  requestingDoctorAuthUid: z.string().optional(),
  requestingDoctorSpecialty: z.string().optional(),
  requestingDoctorLicenseNumber: z.string().optional(),
  requestingDoctorContactPhone: z.string().optional(),
  requestingDoctorStatus: z.enum(["active", "inactive"]).optional(),
  requestingDoctorNotes: z.string().optional(),
  sampleType: z.string().optional(),
...
const TwoPQFormMutationSchema = z.discriminatedUnion("formType", [
  ...
  z.object({
    ...
    selectedRequestingDoctorId: z.string().optional(),
    patientInformation: TwoPQPatientInformationSchema,
    requestedTest: TwoPQRequestedTestSchema,
