export const en = {
  ...
  pocketGenes: {
    ...
    integrationCtaTitle: 'See your report inside Pocket Genes',
    integrationCtaDesc: 'Share a sample report structure and we will review how it can become a mobile experience for your users, with optional community and provider discovery layers.',
  ...
  hero: {
    ...
    stat1Number: 'Mobile',
    stat1Label: 'Clear reports',
    stat2Number: 'RareFriends™',
    stat2Label: 'Optional community',
    stat3Number: 'Directory',
    stat3Label: 'Provider visibility',
  ...
  panels: {
    ...
    ancestryTitle: 'Optional RareFriends™',
    ancestryDesc: 'People and families who opt in can access safe circles and resources related to rare disease journeys.',
  ...
  integrationRevamp: {
    outcome: {
      ...
      afterItems: [
        ...
        'RareFriends™ offers optional access to support circles and resources.',
    ...
    journey: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'When appropriate, RareFriends™ access and provider visibility options are enabled.',
        },
        {
  ...
  thirdSection: {
    ...
    title2: 'three layers of value',
    description: 'Pocket Genes turns your genetic service into a mobile experience, adds an optional community support layer, and creates a provider discovery path for your organization.',
    ...
    boostEngagement: 'Optional RareFriends™',
    boostEngagementDesc: 'Users who opt in can access safe circles, resources, and support for rare disease journeys.',
  ...
  choosePlan: {
    ...
    subtitle: 'Plans combine mobile experience, branding, technical support, optional RareFriends™ access, and visibility inside the ecosystem.',
    freePlan: 'Free',
    freeDesc: '<b>Validate at no cost,</b> bringing selected reports into a mobile experience inside Pocket Genes.',
    freeItems: ['$0 Cost', 'Mobile report access', 'Basic provider profile', 'Optional RareFriends™ entry point', 'No app maintenance'],
    plusPlan: 'Plus',
