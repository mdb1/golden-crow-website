...
export const es: Translations = {
  ...
  hero: {
    ...
    explorePlatform: 'Explorar Pocket Genes',
  },
  ...
  panels: {
    ...
    nutritionDesc: 'Contenidos educativos sobre cómo ciertos factores genéticos pueden relacionarse con nutrición, actividad física o bienestar.',
    medicationTitle: 'Respuesta a medicamentos',
    medicationDesc: 'Explicaciones claras sobre cómo la genética puede influir en la respuesta a algunos tratamientos.',
    ancestryTitle: 'Ascendencia y rasgos',
    ancestryDesc: 'Explorá ascendencia genética y características heredadas con contexto y límites claros.',
  ...
  plan: {
    ...
    quickStartFeature: 'Ideal para validar la experiencia con una inversión inicial baja.',
    quickStartPlan: 'Free',
    quickStartLabel: 'Lanzamiento rápido',
    proBrandingTitle: 'Experiencia con tu marca',
    proBrandingDesc: 'Sumá tu identidad visual y una visualización de datos adaptada a tus informes.',
    proBrandingFeature: 'Fortalecé tu marca con costos predecibles.',
    proBrandingPlan: 'Plus',
    proBrandingLabel: 'Marca personalizada',
    enterpriseTitle: 'App mobile personalizada',
    enterpriseDesc: 'Ofrecé una aplicación independiente, personalizada con tu identidad visual y tus flujos de integración.',
    enterpriseFeature: 'Para equipos que necesitan mayor control, soporte dedicado y funcionalidades a medida.',
    enterprisePlan: 'Full',
    enterpriseLabel: 'App completa',
  },
  ...
  thirdSection: {
    ...
    saveCosts: 'Reducí costos',
    saveCostsDesc: 'Accedé a una experiencia genómica mobile sin asumir todo el costo de una app propia.',
    boostEngagement: 'Mejorá el uso',
    boostEngagementDesc: 'Una experiencia clara e interactiva ayuda a que los usuarios entiendan y vuelvan a consultar sus informes.',
    scaleEasily: 'Escalá con facilidad',
    scaleEasilyDesc: 'Nosotros gestionamos la experiencia mobile para que tu equipo pueda enfocarse en sus informes y usuarios.',
  },
  ...
  choosePlan: {
    ...
    freeItems: ['$0 costo', 'Acceso a informes', 'Sin mantenimiento', 'Despliegue rápido', 'Experiencia fluida'],
    plusPlan: 'Plus',
    plusDesc: 'Agregá <b>marca personalizada</b>, visualización optimizada de datos y <b>prioridad para nuevas funcionalidades.</b>',
    plusItems: ['Marca personalizada', 'Visualización optimizada', 'Soporte para formato de datos', 'Solicitudes prioritarias', 'Precios accesibles'],
    fullPlan: 'Full',
    fullDesc: 'Obtené una app independiente <b>con tu marca</b>, <b>funcionalidades a medida</b> y <b>soporte dedicado.</b>',
    fullItems: ['Experiencia con tu marca', 'Funcionalidades e interfaz a medida', 'Control de datos de usuario', 'Opciones avanzadas de integración', 'Equipo dedicado'],
  },
  ...
  experience: {
    ...
    paragraph1: 'Durante los últimos cuatro años, trabajamos con marcas de fitness, nutrición y salud para desarrollar soluciones mobile que mejoran la participación de los usuarios.',
    paragraph2: 'Respaldados por más de una década de experiencia en desarrollo de software, nuestro equipo diverso —desarrolladores, diseñadores, especialistas de producto, asesores legales y biotecnólogos— se enfoca en entregar experiencias claras, fluidas y basadas en ciencia.',
