      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Platform decision record', 'Platform preference, report-access activation, optional communication choice, or informed-consent upload status.', 'When the evidentiary, provider, audit, or legal need ends.', 'Expiry of evidentiary requirement, deletion request where applicable, or workflow retirement.', 'Legal claim, provider audit, compliance requirement, or dispute.'],
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Registro de decisión de plataforma', 'Preferencia de plataforma, activación de acceso a informe, preferencia de comunicación opcional o estado de carga de consentimiento informado.', 'Cuando termina necesidad probatoria, de proveedor, auditoría o legal.', 'Fin de requerimiento probatorio, solicitud aplicable o retiro de flujo.', 'Reclamo legal, auditoría de proveedor, cumplimiento o disputa.'],
