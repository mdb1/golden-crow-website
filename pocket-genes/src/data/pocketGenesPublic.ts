...
export const trustDocuments: TrustDocument[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Privacy, security, and accessibility contact', POCKET_GENES_EMAILS.trust],
            ['Data-protection representative or DPO', 'Not separately appointed in this Trust Center. Requests are routed through the same contact channel.'],
          ],
        },
      },
      {
        ...
        subsections: [
          {
            ...
            body: 'Information relating to an identified or identifiable person, including account, contact, technical, integration, platform decision, support, and community information.',
          },
          {
          ...
          },
          {
            ...
            body: 'Limited information provided by a participating organization or generated by Pocket Genes to connect the intended person with a report-access path, service invitation, provider document, or organization workflow.',
          },
          {
            heading: 'Platform decision record',
            body: 'A record that identifies a platform action such as Terms acceptance, Privacy Policy acknowledgement, report-access activation, optional communication preference, or provider-document workflow status.',
          },
          {
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Integration data', 'Provider or organization, invitation state, access reference, report code, provider reference, contact fields needed to reach the intended user.', 'Integrator, report provider, Pocket Genes, or the user during onboarding.', 'Connect the intended user with the relevant Pocket Genes experience, provider report path, provider document, or organization workflow.', 'Relevant backend, database, authentication, and infrastructure providers; the originating integrator only as needed for the integration.', 'Current system behavior is tied to workflow completion, rejection, revocation, account deletion, or manual cleanup. No public automatic expiration is stated unless a specific integration publishes one.'],
            ['Platform decision records', 'Purpose, document or screen version, status, timestamp, workflow, account, provider or organization reference where applicable.', 'User action, caregiver or authorized representative action, and Pocket Genes workflow records.', 'Document Terms acceptance, Privacy Policy acknowledgement, feature settings, report-access activation, optional communication preferences, and workflow accountability.', 'Infrastructure providers and internal reviewers who need the record for the relevant workflow.', 'May outlive temporary contact information where needed to prove the decision, handle audit, resolve disputes, or satisfy legal obligations.'],
      ...
      {
        heading: 'Information received to start an integration',
        paragraphs: [
      ...
      {
        heading: 'Informed consent for a genetic study',
        paragraphs: [
          'In some integrations, the professional or provider responsible for a genetic study may use Pocket Genes to send the patient the corresponding informed-consent document.',
          ...
          'The provider or professional responsible for the study is accountable for the document contents, the required explanations, and the decision about whether the informed consent obtained allows the study to proceed.',
          'Pocket Genes acts as a technical channel to facilitate sending, presenting, and returning the document. Processing and temporary retention of any related record is limited to what is necessary to complete that process and is governed by the Data-Retention and Deletion Policy.',
      ...
      {
        heading: 'Terms, privacy, and optional preferences',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          `Users can contact ${POCKET_GENES_OPERATOR.privacyContact} to request access, correction, deletion, a change to platform preferences where available, account closure, or information about a specific integration source.`,
      ...
      },
      {
        ...
        bullets: [
          ...
          'Integrators must have authority to provide contact or identifying information to Pocket Genes and must provide accurate source, purpose, legal basis, and provider document context.',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Pocket Genes may provide mobile access to provider-connected genetic reports, education about genetic concepts, glossary and lesson content, discovery of organizations, resources and events, trusted-organization content, RareFriends community features, access and provider document workflows, support, and optional communications.',
      ...
      {
        heading: 'Invitations and access decisions',
        bullets: [
          'An invitation may let a person create an account, confirm identity, activate report access, review a provider document, or decide whether to continue.',
          'Platform decision records must identify the purpose, document or workflow version, status, time, and related provider or organization where applicable.',
          ...
          'Changing a preference or revoking access where supported may stop a future workflow but may not erase provider records, past lawful processing, security records, or evidence needed for legal or audit reasons.',
        ],
      },
      {
      ...
      },
      {
        heading: 'Pocket Genes responsibilities',
        bullets: [
          'Operate account, access, platform decision, education, discovery, community, and support workflows according to published Trust Center boundaries.',
  ...
  },
  {
    ...
    category: 'Security',
    summary:
      'Separates provider document handling before a study, report access after a study, and optional education or community features.',
    ...
    sections: [
      {
        heading: 'Purpose and scope',
        paragraphs: [
          'This page separates three different Pocket Genes data paths: provider document handling before a study, private report access after a study, and optional education or community features. It is not a server topology diagram and does not expose implementation secrets.',
      ...
      {
        heading: 'Flow A: before the study',
        body:
          'This lane applies only when a doctor, laboratory, clinic, or study provider uses Pocket Genes as the technical channel for an informed-consent document before a genetic study.',
        flow: {
          labels: {
            actor: 'Actor',
          ...
          steps: [
            {
              title: 'Provider initiates the process',
              actor: 'Doctor, laboratory, clinic, or study provider',
              information: 'Name, surname, email, optional phone, provider reference, and study-flow reference.',
              action: 'Receives the minimum information needed to contact the intended person.',
              retained: 'Temporary workflow information is retained only as needed for the integration workflow and applicable retention rules.',
              control: 'The person can continue, decline, request information, object, or request deletion where applicable.',
            },
            {
              title: 'Pocket Genes sends a service communication',
              actor: 'Pocket Genes',
              information: 'Contact details, source provider, invitation state, and workflow reference.',
              action: 'Contacts the person on behalf of the participating provider and explains who initiated the process.',
              retained: 'Contact information remains limited to the service workflow and cleanup or deletion rules.',
              control: 'The person can ignore the message, decline the process, contact support, or submit a privacy request.',
            },
            {
              title: 'Provider document is presented',
              actor: 'Responsible provider and patient',
              information: 'Provider-prepared informed-consent document and related workflow status.',
              action: 'Presents or transmits the provider document without turning it into a Pocket Genes platform decision.',
              retained: 'The provider is expected to retain the medical document; Pocket Genes keeps only the minimum workflow state needed to complete the channel unless an integration states otherwise.',
              control: 'The patient decides whether to proceed with the study in the provider document.',
            },
            {
              title: 'Decision returns to the provider',
              actor: 'Patient, Pocket Genes, and provider',
              information: 'Decision status, timestamp, provider reference, and document workflow reference.',
              action: 'Transmits or makes the decision available to the responsible provider according to the integration.',
              retained: 'Any Pocket Genes record is limited to technical evidence needed for routing, support, audit, dispute, or legal requirements.',
              control: 'Clinical questions or withdrawal from the study must be directed to the responsible provider; Pocket Genes may help route the request.',
            },
          ],
        },
      },
      {
        ...
        body:
          'This lane applies when a provider has created or controls a report and Pocket Genes helps an authorized user access it.',
        flow: {
          labels: {
            actor: 'Actor',
            information: 'Information involved',
          ...
          steps: [
            {
              title: 'Provider maintains the report',
              actor: 'Report provider',
              information: 'Provider-controlled report, findings, and report resources.',
              action: 'Does not create or control the underlying report.',
              retained: 'The provider controls the report and its medical or scientific record.',
              control: 'Questions about report content go to the provider or qualified professional.',
            },
            {
              title: 'Access reference is received',
              actor: 'Provider and Pocket Genes',
              information: 'Link, code, token, identifier, provider reference, or similar access value.',
              action: 'Receives only what is needed to connect the intended user with the provider report path.',
              retained: 'Access references follow expiry, revocation, account deletion, provider relationship, and integration cleanup rules.',
              control: 'The user can protect links, sign out, request revocation, or request deletion where applicable.',
            },
            {
              title: 'User signs in',
              actor: 'User and Pocket Genes',
              information: 'Account id, login information, session state, and security events.',
              action: 'Verifies identity before private report-access operations.',
              retained: 'Account and security information follows account and security retention rules.',
              control: 'The user manages the account and can request closure.',
            },
            {
              title: 'Report access is made available',
              actor: 'Pocket Genes and user',
              information: 'Authorized report-access state and provider reference.',
              action: 'Shows the corresponding report-access option to the authorized user.',
              retained: 'State remains tied to the integration, revocation, account deletion, or provider cleanup path.',
              control: 'Opening a report does not publish it or enroll the user in community features.',
            },
          ],
        },
      },
      ...
      },
      {
        ...
        bullets: [
          ...
          'The responsible provider remains responsible for study-specific documents and for deciding whether a study can proceed.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Document access, request, deletion, and incident paths.',
        ],
      },
      {
        heading: 'User, integrator, and organization responsibilities',
    ...
    sections: [
      {
        heading: 'Purpose and scope',
        paragraphs: [
          'This policy explains how Pocket Genes retains, deletes, de-identifies, or preserves information in account, integration, platform decision, provider document, report-access, community, support, log, and backup workflows.',
      ...
      },
      {
        ...
        paragraphs: [
          'Platform decision records may outlive temporary contact information because Pocket Genes may need evidence of the decision, document or screen version, workflow, time, and provider or organization relationship. This is separate from retaining a complete report or unnecessary invitation information.',
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          { heading: 'Versioning and publication', body: 'Material changes should keep a version or review record when content is used in a regulated, provider document, provider, or safety-sensitive context.' },
...
export const trustDocumentsEs: TrustDocument[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Contacto para privacidad, seguridad y accesibilidad', POCKET_GENES_EMAILS.trust],
            ['Representante de protección de datos o DPO', 'No se designa por separado en este Centro de confianza. Las solicitudes se canalizan por el mismo canal de contacto.'],
          ],
        },
      },
      {
        ...
        subsections: [
          { heading: 'Información personal', body: 'Información referida a una persona identificada o identificable, incluyendo datos de cuenta, contacto, técnicos, integración, decisiones de plataforma, soporte y comunidad.' },
          ...
          { heading: 'Información de integración', body: 'Información limitada provista por una organización participante o generada por Pocket Genes para conectar a la persona prevista con un acceso a informe, invitación de servicio, documento de proveedor u organización.' },
          { heading: 'Registro de decisión de plataforma', body: 'Registro que identifica una acción de plataforma, como aceptación de Términos, aviso de Política de Privacidad, activación de acceso a informe, preferencia de comunicación opcional o estado de un documento de proveedor.' },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Datos de integración', 'Proveedor u organización, estado de invitación, referencia de acceso, código de informe, referencia de proveedor y campos de contacto.', 'Integrador, proveedor, Pocket Genes o usuario durante onboarding.', 'Conectar a la persona con la experiencia correspondiente de Pocket Genes, acceso a informe, documento de proveedor o flujo de organización.', 'Backend, base de datos, autenticación e infraestructura relevantes; el integrador de origen solo cuando sea necesario.', 'El comportamiento actual se vincula a finalización, rechazo, revocación, eliminación de cuenta o limpieza manual. No se publica vencimiento automático salvo que una integración lo indique.'],
            ['Registros de decisiones de plataforma', 'Propósito, versión de documento o pantalla, estado, fecha, flujo, cuenta y referencia de proveedor u organización cuando corresponda.', 'Acción del usuario, cuidador o representante y registros de Pocket Genes.', 'Documentar aceptación de Términos, aviso de Política de Privacidad, configuración de funciones, activación de acceso a informe, preferencias de comunicaciones opcionales y trazabilidad del flujo.', 'Proveedores de infraestructura y revisores internos que necesitan el registro.', 'Puede sobrevivir a datos temporales de contacto si hace falta probar la decisión, auditar, resolver disputas o cumplir obligaciones.'],
      ...
      {
        heading: 'Información recibida para iniciar una integración',
        paragraphs: [
          'Un laboratorio, clínica, profesional u otra organización participante puede proporcionar a Pocket Genes datos básicos como nombre, apellido, correo electrónico y, cuando corresponda, teléfono.',
          'Pocket Genes utiliza esta información para enviar comunicaciones relacionadas con el servicio, identificar a la persona destinataria y facilitar el proceso correspondiente.',
          'La organización que proporciona los datos es responsable de contar con la autoridad o base legal necesaria para hacerlo. Al contactar a la persona, Pocket Genes informa quién proporcionó sus datos, por qué los recibió y cómo puede solicitar información, oponerse o pedir su eliminación cuando corresponda.',
        ],
      },
      {
        heading: 'Consentimiento informado para un estudio',
        paragraphs: [
          'En algunas integraciones, el profesional o proveedor responsable de un estudio genético puede utilizar Pocket Genes para enviar al paciente el documento de consentimiento informado correspondiente.',
          'El consentimiento informado se refiere a la decisión del paciente de aceptar o rechazar el estudio después de recibir del profesional responsable información clara sobre su finalidad, procedimiento, beneficios, riesgos, alternativas y consecuencias relevantes.',
          'El proveedor o profesional a cargo del estudio responde por el contenido del documento, las explicaciones necesarias y la decisión sobre si el consentimiento informado obtenido permite avanzar.',
          'Pocket Genes actúa como canal técnico para facilitar el envío, la presentación y la devolución del documento. El tratamiento y la conservación temporal de cualquier registro relacionado se limitan a lo necesario para completar ese proceso y se rigen por la Política de Retención y Eliminación de Datos.',
          'El consentimiento informado para el estudio es independiente de la Política de Privacidad, los Términos de Servicio y las preferencias opcionales de Pocket Genes.',
        ],
      },
      {
        heading: 'Términos, privacidad y preferencias opcionales',
        paragraphs: [
          'La Política de Privacidad explica cómo Pocket Genes trata los datos personales necesarios para operar la plataforma. Los Términos de Servicio establecen las condiciones de uso de Pocket Genes.',
          'Las preferencias relacionadas con PockeAmigos, la visibilidad del perfil, las notificaciones, newsletters y otras comunicaciones opcionales se gestionan por separado.',
          'Estas opciones son configuraciones de plataforma, no aprobaciones de estudio ni decisiones clínicas.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          `Los usuarios pueden escribir a ${POCKET_GENES_EMAILS.trust} para solicitar acceso, corrección, eliminación, cambio de preferencias de plataforma cuando esté disponible, cierre de cuenta o información sobre una fuente de integración.`,
      ...
      },
      {
        ...
        bullets: [
          ...
          'Las comunicaciones de servicio se limitan a cuenta, soporte, invitación, acceso a informe, seguridad, accesibilidad, incidentes y operación.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Los integradores deben tener autoridad para aportar datos de contacto o identificación y brindar contexto de fuente, propósito, base válida y documento de proveedor aplicable.',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Pocket Genes puede brindar acceso móvil a informes conectados con proveedores, educación sobre conceptos genéticos, glosario y lecciones, descubrimiento de organizaciones, recursos y eventos, contenido de organizaciones de confianza, PockeAmigos, flujos de acceso y documentos de proveedor, soporte y comunicaciones opcionales.',
      ...
      {
        heading: 'Invitaciones y decisiones de acceso',
        bullets: [
          'Una invitación puede permitir crear cuenta, confirmar identidad, activar acceso a informe, revisar un documento del proveedor o decidir si continuar.',
          'Los registros de decisión de plataforma deben identificar propósito, versión, estado, fecha y proveedor u organización relacionados cuando corresponda.',
          ...
          'Cambiar una preferencia o revocar un acceso cuando la función lo permita puede detener flujos futuros, pero no borrar registros de proveedor, tratamiento previo válido, registros de seguridad o evidencia legal/auditoría.',
        ],
      },
      {
      ...
      },
      {
        heading: 'Responsabilidades de Pocket Genes',
        bullets: [
          'Operar cuentas, acceso, decisiones de plataforma, educación, descubrimiento, comunidad y soporte según los límites publicados.',
    ...
    sections: [
      {
        heading: 'Propósito y alcance',
        paragraphs: [
          'Esta página separa tres recorridos de datos distintos en Pocket Genes: manejo de documentos de proveedor antes de un estudio, acceso privado a informes después del estudio y funciones opcionales de educación o comunidad. No es un diagrama de topología de servidores ni expone secretos de implementación.',
          'El objetivo es mostrar qué información entra en cada recorrido, quién responde, qué hace Pocket Genes, si se conserva y qué controla el usuario.',
        ],
      },
      {
        heading: 'A quién se aplica',
      ...
      {
        heading: 'Flujo A: antes del estudio',
        body:
          'Este recorrido aplica solo cuando un médico, laboratorio, clínica o proveedor del estudio usa Pocket Genes como canal técnico para un documento de consentimiento informado antes de realizar un estudio genético.',
        flow: {
          labels: {
            actor: 'Actor',
          ...
          steps: [
            {
              title: 'El proveedor inicia el proceso',
              actor: 'Médico, laboratorio, clínica o proveedor del estudio',
              information: 'Nombre, apellido, correo electrónico, teléfono opcional, referencia de proveedor y referencia del flujo del estudio.',
              action: 'Recibe la información mínima necesaria para contactar a la persona indicada.',
              retained: 'La información temporal del flujo se conserva solo mientras sea necesaria para la integración y las reglas de retención aplicables.',
              control: 'La persona puede continuar, rechazar, pedir más información, oponerse o solicitar eliminación cuando corresponda.',
            },
            {
              title: 'Pocket Genes envía una comunicación de servicio',
              actor: 'Pocket Genes',
              information: 'Datos de contacto, proveedor de origen, estado de la invitación y referencia del flujo.',
              action: 'Contacta a la persona en nombre del proveedor participante y explica quién inició el proceso.',
              retained: 'Los datos de contacto quedan limitados al flujo de servicio y a sus reglas de limpieza o eliminación.',
              control: 'La persona puede ignorar el mensaje, rechazar el proceso, contactar soporte o presentar una solicitud de privacidad.',
            },
            {
              title: 'Se presenta el documento del proveedor',
              actor: 'Proveedor responsable y paciente',
              information: 'Documento de consentimiento informado preparado por el proveedor y estado del flujo relacionado.',
              action: 'Presenta o transmite el documento del proveedor sin convertirlo en una decisión general de plataforma.',
              retained: 'El proveedor conserva el documento médico según sus obligaciones; Pocket Genes conserva solo el estado mínimo necesario para completar el canal salvo que una integración indique otra cosa.',
              control: 'El paciente decide si avanzar con el estudio en el documento del proveedor.',
            },
            {
              title: 'La decisión vuelve al proveedor',
              actor: 'Paciente, Pocket Genes y proveedor',
              information: 'Estado de la decisión, fecha, referencia de proveedor y referencia del documento.',
              action: 'Transmite o deja disponible la decisión al proveedor responsable según la integración.',
              retained: 'Cualquier registro de Pocket Genes se limita a la evidencia técnica necesaria para enrutamiento, soporte, auditoría, disputa o requisitos legales.',
              control: 'Las preguntas clínicas o cambios vinculados con el estudio deben dirigirse al proveedor responsable; Pocket Genes puede ayudar a derivar la solicitud.',
            },
          ],
        },
      },
      {
        ...
        body:
          'Este recorrido aplica cuando un proveedor ya creó o controla un informe y Pocket Genes ayuda a un usuario autorizado a acceder a él.',
        flow: {
          labels: {
            actor: 'Actor',
            information: 'Información involucrada',
          ...
          steps: [
            {
              title: 'El proveedor conserva el informe',
              actor: 'Proveedor del informe',
              information: 'Informe, hallazgos y recursos del informe controlados por el proveedor.',
              action: 'No crea ni controla el informe subyacente.',
              retained: 'El proveedor controla el informe y su registro médico o científico.',
              control: 'Las preguntas sobre el contenido del informe deben dirigirse al proveedor o a un profesional calificado.',
            },
            {
              title: 'Se recibe una referencia de acceso',
              actor: 'Proveedor y Pocket Genes',
              information: 'Enlace, código, token, identificador, referencia de proveedor o valor similar de acceso.',
              action: 'Recibe solo lo necesario para conectar al usuario previsto con el camino de acceso al informe del proveedor.',
              retained: 'Las referencias de acceso siguen reglas de vencimiento, revocación, eliminación de cuenta, relación con el proveedor y limpieza de integración.',
              control: 'El usuario puede proteger enlaces, cerrar sesión, pedir revocación o solicitar eliminación cuando corresponda.',
            },
            {
              title: 'El usuario inicia sesión',
              actor: 'Usuario y Pocket Genes',
              information: 'ID de cuenta, información de login, estado de sesión y eventos de seguridad.',
              action: 'Verifica la identidad antes de permitir operaciones privadas de acceso a informes.',
              retained: 'La información de cuenta y seguridad sigue las reglas de retención aplicables.',
              control: 'El usuario gestiona su cuenta y puede solicitar el cierre.',
            },
            {
              title: 'El acceso al informe queda disponible',
              actor: 'Pocket Genes y usuario',
              information: 'Estado de acceso al informe autorizado y referencia de proveedor.',
              action: 'Muestra al usuario autorizado la opción de acceso correspondiente.',
              retained: 'El estado queda vinculado a la integración, revocación, eliminación de cuenta o limpieza del proveedor.',
              control: 'Abrir un informe no lo publica ni suma al usuario a funciones comunitarias.',
            },
          ],
        },
      },
      ...
      },
      {
        ...
        bullets: [
          ...
          'El proveedor responsable conserva responsabilidad sobre los documentos específicos del estudio y sobre si el estudio puede avanzar.',
          'Pocket Genes responde por cuenta, acceso, integración, educación, descubrimiento y comunidad que opera.',
          'Acceder a un informe no lo publica.',
          'Unirse a PockeAmigos no revela un informe a otros usuarios.',
          'Usar funciones educativas o comunitarias es opcional y no forma parte de una decisión de estudio.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Documentar accesos, solicitudes, eliminación e incidentes.',
        ],
      },
      {
        heading: 'Responsabilidades de usuarios, integradores y organizaciones',
    ...
    sections: [
      {
        heading: 'Propósito y alcance',
        paragraphs: [
          'Esta política explica cómo Pocket Genes conserva, elimina, desidentifica o preserva información en cuentas, integraciones, decisiones de plataforma, documentos de proveedor, acceso a informes, comunidad, soporte, logs y backups.',
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Registro de decisión de plataforma', 'Preferencia de plataforma, activación de acceso a informe, preferencia de comunicación opcional, aceptación documental o estado de un documento de proveedor.', 'Cuando termina necesidad probatoria, de proveedor, auditoría o legal.', 'Fin de requerimiento probatorio, solicitud aplicable o retiro de flujo.', 'Reclamo legal, auditoría de proveedor, cumplimiento o disputa.'],
            ['Referencia o enlace de informe', 'Creación de enlace, código, token, referencia o estado de acceso.', 'Vencimiento, revocación, fin de relación con proveedor, eliminación de cuenta o limpieza.', 'Solicitud, revocación de proveedor, eliminación de cuenta o limpieza de integración.', 'Soporte, incidente de seguridad, retención legal, disputa con proveedor.'],
      ...
      },
      {
        ...
        paragraphs: [
          'Los registros de decisión de plataforma pueden sobrevivir a datos temporales de contacto porque Pocket Genes puede necesitar evidencia de decisión, versión de documento o pantalla, flujo, fecha y proveedor u organización. Esto es distinto de conservar un informe completo o información de invitación innecesaria.',
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          { heading: 'Versionado y publicación', body: 'Los cambios materiales deben conservar versión o revisión cuando el contenido se usa en contextos regulados, de documentos de proveedor, proveedor o seguridad.' },
