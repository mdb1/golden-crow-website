...
const publicNavItemsByLocale: Record<PocketGenesPublicLocale, { label: string; href: string }[]> = {
  en: [
    ...
    { label: 'RareFriends™ Community', href: '/pocket-genes/rarefriends' },
    { label: 'Join us', href: '/pocket-genes/join-us' },
    { label: 'Integration', href: '/pocket-genes/website/integration' },
    { label: 'Solutions', href: '/pocket-genes/solutions' },
  ...
  es: [
    ...
    { label: 'Comunidad PockeAmigos™', href: '/pocket-genes/rarefriends' },
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            body: 'Limited information provided by a participating organization or generated by Pocket Genes to connect the intended person with a report-access path, service invitation, informed-consent workflow, or organization workflow.',
          },
          {
            heading: 'Platform decision record',
            body: 'A record that identifies a platform action such as Terms acceptance, Privacy Policy acknowledgement, report-access activation, optional communication preference, informed-consent upload status, or report-access workflow status.',
          },
          {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Provider links, portals, laboratory services, clinical services, or external resources may have separate terms, privacy notices, availability limits, and support channels. Pocket Genes cannot guarantee that provider-controlled resources will remain available.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          'An invitation may let a person create an account, confirm identity, activate report access, upload informed consent, or decide whether to continue.',
          'Platform decision records must identify the purpose, screen or workflow version, status, time, and related provider or organization where applicable.',
          ...
          'Changing a preference or revoking access where supported may stop a future workflow but may not erase provider records, past lawful processing, security records, or evidence needed for legal, security, or dispute reasons.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Pocket Genes does not control every provider report, external resource, or user statement.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Moderators may preserve limited evidence when needed to investigate abuse, record the decision, handle repeat behavior, or comply with legal obligations. Preserved evidence should be restricted to people with a need to know.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Act proportionally and record important decisions.',
        ...
        flow: {
          ...
          steps: [
            ...
            },
            {
              ...
              actor: 'Doctor, clinic, laboratory, or responsible study provider',
              information: 'Consent-upload status, timestamp, study reference, report reference, and uploaded file when authorized.',
              action: 'The responsible doctor, clinic, laboratory, or provider confirms and validates that the informed-consent file was uploaded.',
              retained: 'The validation status and file remain tied to the study workflow and its retention rules.',
          ...
          steps: [
            {
              ...
              action: 'The provider uploads the report so it can be viewed by the authorized doctor and patient.',
            ...
            },
            {
              ...
              action: 'The doctor or patient signs in securely with enabled credentials or with the security key provided by the system.',
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          { heading: 'Provider public information', body: 'Public privacy, security, data-processing, or service information published by the provider.' },
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          { heading: 'Legal or safety hold', body: 'A narrow preservation reason such as security investigation, legal claim, abuse evidence, fraud prevention, or statutory obligation.' },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Account data', 'Account creation or invitation acceptance.', 'Account deletion plus active-system deletion process and backup rotation.', 'Verified user request, authorized admin deletion, or account closure workflow.', 'Legal, fraud-prevention, security, payment, or dispute requirement.'],
            ['Platform decision record', 'Platform preference, report-access activation, optional communication choice, or informed-consent upload status.', 'When the evidentiary, provider, or legal need ends.', 'Expiry of evidentiary requirement, deletion request where applicable, or workflow retirement.', 'Legal claim, compliance requirement, or dispute.'],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: 'Definitions',
        subsections: [
          { heading: 'Provider finding', body: 'A result, interpretation, variant, panel, file, or conclusion supplied by the report provider.' },
      ...
      },
      {
        ...
        bullets: [
          'Provider-supplied report findings and informed-consent materials.',
      ...
      },
      {
        ...
        subsections: [
          ...
          { heading: 'Source research', body: 'Drafting should use sources appropriate to the topic, such as government or public-health resources, recognized genetics databases actually used in the process, professional guidelines, peer-reviewed literature, provider public information, and standard scientific terminology.' },
          ...
          { heading: 'Versioning and publication', body: 'Material changes should keep a version or review record when content is used in a regulated, informed-consent, provider, or safety-sensitive context.' },
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          { heading: 'Información de integración', body: 'Información limitada provista por una organización participante o generada por Pocket Genes para conectar a la persona prevista con un acceso a informe, invitación de servicio, flujo de consentimiento informado o flujo de organización.' },
          { heading: 'Registro de decisión de plataforma', body: 'Registro que identifica una acción de plataforma, como aceptación de Términos, aviso de Política de Privacidad, activación de acceso a informe, preferencia de comunicación opcional o estado de carga de consentimiento informado.' },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Datos de integración', 'Proveedor u organización, estado de invitación, referencia de acceso, código de informe, referencia de proveedor y campos de contacto.', 'Integrador, proveedor, Pocket Genes o usuario durante onboarding.', 'Conectar a la persona con la experiencia correspondiente de Pocket Genes, acceso a informe, flujo de consentimiento informado o flujo de organización.', 'Backend, base de datos, autenticación e infraestructura relevantes; el integrador de origen solo cuando sea necesario.', 'El comportamiento actual se vincula a finalización, rechazo, revocación, eliminación de cuenta o limpieza manual. No se publica vencimiento automático salvo que una integración lo indique.'],
            ['Registros de decisiones de plataforma', 'Propósito, versión de pantalla o política, estado, fecha, flujo, cuenta y referencia de proveedor u organización cuando corresponda.', 'Acción del usuario, cuidador o representante y registros de Pocket Genes.', 'Registrar aceptación de Términos, aviso de Política de Privacidad, configuración de funciones, activación de acceso a informe, preferencias de comunicaciones opcionales y trazabilidad del flujo.', 'Proveedores de infraestructura y revisores internos que necesitan el registro.', 'Puede sobrevivir a datos temporales de contacto si hace falta probar la decisión, resolver disputas o cumplir obligaciones.'],
      ...
      },
      {
        ...
        paragraphs: [
          'En algunas integraciones, el profesional o proveedor responsable de un estudio genético puede utilizar Pocket Genes para pedirle al paciente que suba el archivo de consentimiento informado requerido.',
          ...
          'El proveedor o profesional a cargo del estudio responde por las explicaciones necesarias y por decidir si el consentimiento informado cargado permite avanzar.',
          'Pocket Genes actúa como canal técnico para la solicitud de carga, las instrucciones de acceso, la carga del archivo y el estado del consentimiento. El tratamiento y la conservación temporal de cualquier registro relacionado se limitan a lo necesario para completar ese proceso y se rigen por la Política de Retención y Eliminación de Datos.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Los integradores deben tener autoridad para aportar datos de contacto o identificación y brindar contexto de fuente, propósito, base válida y consentimiento informado o acceso a informe aplicable.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Pueden conservarse registros de moderación, incidentes, fraude, legales o seguridad cuando sea necesario.',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Pocket Genes puede brindar acceso móvil a informes conectados con proveedores, educación sobre conceptos genéticos, glosario y lecciones, descubrimiento de organizaciones, recursos y eventos, contenido de organizaciones de confianza, PockeAmigos™, flujos de acceso y consentimiento informado, soporte y comunicaciones opcionales.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Los enlaces, portales, servicios de laboratorio o clínicos y recursos externos del proveedor pueden tener términos, privacidad, disponibilidad y soporte propios. Pocket Genes no garantiza disponibilidad continua de recursos controlados por proveedores.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          'Una invitación puede permitir crear cuenta, confirmar identidad, activar acceso a informe, subir consentimiento informado o decidir si continuar.',
          ...
          'Cambiar una preferencia o revocar un acceso cuando la función lo permita puede detener flujos futuros, pero no borrar registros de proveedor, tratamiento previo válido, registros de seguridad o evidencia legal, de seguridad o disputa.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Pocket Genes no controla cada informe de proveedor, recurso externo o declaración de usuario.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Moderadores pueden preservar evidencia limitada para investigar abuso, registrar decisiones, manejar repetición o cumplir obligaciones. Esa evidencia debe quedar restringida a personas con necesidad de acceso.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Actuar proporcionalmente y registrar decisiones importantes.',
    ...
    sections: [
      {
        heading: 'Propósito y alcance',
        paragraphs: [
          'Esta página separa tres recorridos de datos distintos en Pocket Genes: manejo del consentimiento informado antes de un estudio, acceso privado a informes genéticos después del estudio y funciones opcionales de educación o comunidad. No es un diagrama de topología de servidores ni expone secretos de implementación.',
          'El objetivo es mostrar qué información participa en cada recorrido, quién es responsable, qué hace Pocket Genes, qué se conserva y qué controla el usuario.',
        ],
      },
      {
        heading: 'A quién se aplica',
      ...
      },
      {
        heading: 'Definiciones',
        subsections: [
          { heading: 'Proveedor', body: 'Organización que crea, entrega o controla el informe genético o el recurso asociado.' },
          { heading: 'Integrador', body: 'Proveedor, clínica, laboratorio, organización o programa que conecta a una persona con una experiencia de Pocket Genes.' },
          { heading: 'Referencia de acceso', body: 'URL, código, token, identificador, referencia de proveedor o valor similar que permite vincular a un usuario autorizado con un informe.' },
          { heading: 'Participación en la comunidad', body: 'Acciones opcionales en PockeAmigos™, como crear un perfil, encontrar coincidencias, seguir grupos, publicar, comentar o enviar mensajes.' },
        ],
      },
      {
          ...
          steps: [
            {
              ...
              action: 'El proveedor inicia la solicitud con los datos mínimos del paciente.',
            ...
            {
              title: 'Consentimiento validado',
              actor: 'Médico, clínica, laboratorio o proveedor responsable del estudio',
              ...
              action: 'El médico, la clínica, el laboratorio o el proveedor responsable confirma y valida la carga del consentimiento informado.',
              retained: 'La validación y el archivo quedan asociados al flujo del estudio y a sus reglas de retención.',
          ...
          steps: [
            {
              ...
              action: 'El proveedor sube el reporte para que pueda ser visto por el médico y paciente autorizados.',
            ...
            },
            {
              ...
              action: 'El médico o paciente ingresa de forma segura con sus credenciales habilitadas o con la clave de seguridad provista por el sistema.',
            ...
            },
            {
              ...
              action: 'El reporte puede verse, guardarse en la app o descargarse.',
          ...
          steps: [
            {
              ...
              action: 'Pocket Genes muestra recursos y organizaciones sin exponer información privada del informe.',
            ...
            },
            {
              ...
              action: 'El usuario puede participar de manera opcional con perfil, publicaciones, grupos y controles propios.',
      ...
      },
      {
        ...
        bullets: [
          'El proveedor conserva la responsabilidad sobre el informe y sus hallazgos.',
          'El proveedor responsable conserva la responsabilidad sobre el estudio, el requisito de consentimiento informado y la decisión de avanzar.',
          'Pocket Genes es una herramienta de acceso y tránsito seguro para el reporte genético cargado.',
          'Los médicos y pacientes autorizados pueden conservar archivos de reporte descargados fuera de Pocket Genes.',
          'Pocket Genes responde por las funciones de cuenta, acceso, integración, educación, descubrimiento y comunidad que opera.',
          'Acceder a un informe no lo hace público.',
          'Unirse a PockeAmigos™ no expone un informe ante otros usuarios.',
          ...
          'Un integrador no recibe automáticamente la actividad comunitaria posterior del usuario.',
          'La información de los informes no se usa para publicidad según los criterios de uso de datos del Centro de confianza.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Las responsabilidades se mantienen separadas entre proveedores, Pocket Genes, organizaciones y usuarios.',
          'Referencias de acceso y datos privados se tratan como información protegida.',
          'Los accesos, solicitudes, eliminaciones e incidentes se registran cuando hace falta para operación y soporte.',
        ],
      },
      {
        ...
        bullets: [
          ...
          'Los seguimientos, comentarios y la participación comunitaria no exponen datos privados de cuenta o informes ante organizaciones.',
        ],
      },
      {
        heading: 'Excepciones y límites',
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          { heading: 'Información pública del proveedor', body: 'Información pública de privacidad, seguridad, tratamiento de datos o servicio publicada por el proveedor.' },
        ],
      },
      {
        heading: 'Registro público',
        body:
          'Cada proveedor se presenta con entidad legal, servicio, propósito, categorías de información, rol de tratamiento, contexto de transferencias, referencia pública y fecha de revisión.',
        subsections: [
          {
            heading: 'Amazon Web Services',
            bullets: [
              ...
              'Referencia pública: información de privacidad, tratamiento de datos, seguridad y cumplimiento de AWS.',
          ...
          },
          {
            ...
            bullets: [
              ...
              'Referencia pública: información de Google Cloud, Firebase, privacidad, tratamiento de datos y seguridad.',
              `Agregado o revisado: ${TRUST_LAST_REVIEWED_ES}.`,
            ],
          },
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          { heading: 'Retención legal o de seguridad', body: 'Motivo acotado de preservación como investigación de seguridad, reclamo legal, abuso, fraude u obligación.' },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Datos de cuenta', 'Creación de cuenta o aceptación de invitación.', 'Eliminación de cuenta más proceso activo y rotación de backups.', 'Solicitud verificada, eliminación admin autorizada o cierre de cuenta.', 'Requisito legal, fraude, seguridad, pago o disputa.'],
            ['Registro de decisión de plataforma', 'Preferencia de plataforma, activación de acceso a informe, preferencia de comunicación opcional o estado de carga de consentimiento informado.', 'Cuando termina necesidad probatoria, de proveedor o legal.', 'Fin de requerimiento probatorio, solicitud aplicable o retiro de flujo.', 'Reclamo legal, cumplimiento o disputa.'],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: 'Definiciones',
        subsections: [
          { heading: 'Hallazgo de proveedor', body: 'Resultado, interpretación, variante, panel, archivo o conclusión aportada por el proveedor del informe.' },
      ...
      },
      {
        ...
        bullets: [
          'Hallazgos y archivos provistos por proveedores.',
      ...
      },
      {
        ...
        subsections: [
          ...
          { heading: 'Investigación de fuentes', body: 'La redacción debe usar fuentes apropiadas al tema, como recursos gubernamentales o de salud pública, bases de genética realmente usadas, guías profesionales, literatura revisada por pares, información pública de proveedores y terminología científica estándar.' },
          ...
          { heading: 'Versionado y publicación', body: 'Los cambios materiales deben conservar versión o revisión cuando el contenido se usa en contextos regulados, de proveedor o seguridad.' },
