...
export const trustDocuments: TrustDocument[] = [
  {
    ...
    sections: [
        ...
        subsections: [
          {
            ...
            body: 'Information relating to an identified or identifiable person, including account, contact, technical, integration, permission, support, and community information.',
          },
          {
          ...
          },
          {
            ...
            body: 'Limited information provided by a participating organization or generated by Pocket Genes to connect the intended person with a report-access, invitation, authorization, provider document, or organization workflow.',
          },
          {
            heading: 'Decision or authorization record',
            body: 'A record that identifies the purpose of a platform permission, provider-access authorization, optional communication choice, or provider informed consent document when a provider presents one through Pocket Genes.',
          },
          {
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Integration data', 'Provider or organization, invitation state, access reference, report code, provider reference, contact fields needed to reach the intended user.', 'Integrator, report provider, Pocket Genes, or the user during onboarding.', 'Connect the intended user with the authorized Pocket Genes experience, provider authorization path, provider report path, provider document, or organization workflow.', 'Relevant backend, database, authentication, and infrastructure providers; the originating integrator only as needed for the integration.', 'Current system behavior is tied to workflow completion, rejection, revocation, account deletion, or manual cleanup. No public automatic expiration is stated unless a specific integration publishes one.'],
            ['Platform decision records', 'Purpose, document or screen version, status, timestamp, workflow, account, provider or organization reference where applicable.', 'User action, caregiver or authorized representative action, and Pocket Genes workflow records.', 'Document account Terms or Privacy Policy acknowledgement, feature permissions, provider-experience authorization, optional communication choices, and workflow accountability. These records are not medical informed consent for a genetic study.', 'Infrastructure providers and internal reviewers who need the record for the relevant workflow.', 'May outlive temporary contact information where needed to prove the decision, handle audit, resolve disputes, or satisfy legal obligations.'],
      ...
      },
      {
        ...
        paragraphs: [
          'A participating provider, laboratory, clinic, patient organization, support program, or other integrator may provide limited contact or identifying information to start an invitation, report-access, authorization, provider document, or resource workflow for an intended person. This may include name, surname, email, phone number where applicable, provider or organization name, invitation status, and a reference needed to connect the workflow.',
          ...
          'The person is informed during the invitation or onboarding path about who provided the information, why Pocket Genes received it, what platform permission, provider-access authorization, or provider document is being presented, and how to decline, object, or request deletion where applicable.',
        ],
      },
      {
        heading: 'What Pocket Genes records',
        body:
          'Pocket Genes does not treat routine platform data processing as medical informed consent. It records operational decisions by purpose and version so a permission, authorization, Terms or Privacy Policy acknowledgement, optional communication choice, or provider document can be linked to the workflow and decision it records.',
        subsections: [
          {
          ...
          {
            heading: 'Privacy Policy and Terms acknowledgement',
            body: 'Acknowledgement or acceptance of the documents that apply to creating or using an account. This is not medical informed consent and is not consent to perform a genetic test or study.',
          },
          {
            heading: 'Provider-access authorization',
          ...
          {
            heading: 'Provider informed consent documents',
            body: 'When a physician, clinic, laboratory, or study sponsor presents an informed consent document, that consent belongs to the provider and the clinical or study process. Pocket Genes may record only the operational workflow state needed to route or document that provider process.',
          },
          {
      ...
      },
      {
        ...
        paragraphs: [
          'The participating provider remains responsible for the report, the findings, the scientific or clinical interpretation, and the provider-controlled delivery path. Pocket Genes is responsible for the account, integration, access, platform decision, and user-experience layers it operates.',
      ...
      },
      {
        ...
        paragraphs: [
          `Users can contact ${POCKET_GENES_OPERATOR.privacyContact} to request access, correction, deletion, a change or withdrawal of permissions where applicable, account closure, or information about a specific integration source.`,
      ...
      },
      {
        ...
        bullets: [
          ...
          'Service communications are limited to account, support, invitation, authorization, report-access, security, accessibility, incident, and operational needs.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Integrators must have authority to provide contact or identifying information to Pocket Genes and must provide accurate source, purpose, authorization, and provider document context.',
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'Authorizations and invitations',
        bullets: [
          'An invitation may let a person create an account, confirm identity, authorize report access, review a provider document including an informed consent form when a provider presents one, or decide whether to continue.',
          'Decision and authorization records must identify the purpose, document or workflow version, status, time, and related provider or organization where applicable.',
          ...
          'Changing or withdrawing a permission may stop a future workflow but may not erase provider records, past lawful processing, security records, or evidence needed for legal or audit reasons.',
        ],
      },
      {
      ...
      },
      {
        heading: 'Pocket Genes responsibilities',
        bullets: [
          'Operate account, access, authorization, education, discovery, community, and support workflows according to published Trust Center boundaries.',
    ...
    sections: [
      ...
      },
      {
        ...
        flow: {
          ...
          steps: [
            ...
            {
              title: 'Authorization or preference',
              actor: 'User and Pocket Genes',
              information: 'Workflow purpose, document or screen version, status, timestamp, and related provider or workflow where applicable.',
              action: 'Records the decision and continues or stops the workflow.',
              retained: 'Decision records may outlive temporary contact data for accountability.',
              control: 'User can change preferences or withdraw permissions where applicable, subject to limits.',
            },
            {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Pocket Genes is responsible for the account, access, integration, authorization, education, discovery, and community processes it operates.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Document authorization, request, deletion, and incident paths.',
        ],
      },
      {
        heading: 'User, integrator, and organization responsibilities',
  ...
  },
  {
    ...
    category: 'Privacy and rights',
    summary:
      'Explains how long Pocket Genes retains account information, temporary integration data, decision and authorization records, community content, operational logs, backups, and what happens when information is deleted.',
    owner: 'Trust and Privacy',
    status: 'Published',
    ...baseDocumentMetaEn,
    sections: [
      {
        heading: 'Purpose and scope',
        paragraphs: [
          'This policy explains how Pocket Genes retains, deletes, de-identifies, or preserves information in account, integration, authorization, provider document, report-access, community, support, log, and backup workflows.',
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Decision or authorization record', 'Platform permission, provider-access authorization, optional communication choice, document acknowledgement, or provider document decision.', 'When the evidentiary, provider, audit, or legal need ends.', 'Expiry of evidentiary requirement, deletion request where applicable, or workflow retirement.', 'Legal claim, provider audit, compliance requirement, or dispute.'],
      ...
      {
        heading: 'Decision and authorization records',
        paragraphs: [
          'Decision and authorization records may outlive temporary contact information because Pocket Genes may need evidence of the decision, document or screen version, workflow, time, and provider or organization relationship. This is separate from retaining a complete report or unnecessary invitation information.',
...
export const trustDocumentsEs: TrustDocument[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          { heading: 'Información personal', body: 'Información referida a una persona identificada o identificable, incluyendo datos de cuenta, contacto, técnicos, integración, permisos, soporte y comunidad.' },
      ...
      {
        heading: 'Qué registra Pocket Genes',
        body:
          'Pocket Genes no trata el procesamiento habitual de datos de plataforma como consentimiento informado médico. Registra decisiones operativas por propósito y versión para que un permiso, autorización, aceptación de Términos o Política de Privacidad, preferencia de comunicación opcional o documento de proveedor quede vinculado con el flujo y la decisión registrada.',
        subsections: [
          { heading: 'Permiso de contacto', body: 'Permiso para que Pocket Genes contacte por una invitación, proceso de acceso, soporte, flujo de organización o comunicación solicitada.' },
      ...
      },
      {
        ...
        paragraphs: [
          `Los usuarios pueden escribir a ${POCKET_GENES_EMAILS.trust} para solicitar acceso, corrección, eliminación, cambio o retiro de permisos cuando corresponda, cierre de cuenta o información sobre una fuente de integración.`,
      ...
      },
      {
        ...
        bullets: [
          ...
          'Los integradores deben tener autoridad para aportar datos de contacto o identificación y brindar contexto de fuente, propósito, autorización y documento de proveedor aplicable.',
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'Autorizaciones e invitaciones',
        bullets: [
    ...
    sections: [
      ...
      },
      {
        ...
        flow: {
          ...
          steps: [
            ...
            {
              title: 'Autorización o preferencia',
              actor: 'Usuario y Pocket Genes',
              information: 'Propósito del flujo, versión del documento o pantalla, estado, fecha y proveedor o flujo relacionado cuando corresponda.',
              action: 'Registra la decisión y continúa o detiene el flujo.',
              retained: 'El registro de decisión puede conservarse más tiempo que los datos temporales para dejar constancia de la decisión.',
              control: 'El usuario puede cambiar preferencias o retirar permisos cuando corresponda, sujeto a límites aplicables.',
            },
            {
              title: 'Autenticación',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Documentar autorizaciones, solicitudes, eliminación e incidentes.',
        ],
      },
      {
        heading: 'Responsabilidades de usuarios, integradores y organizaciones',
    ...
    sections: [
      {
        heading: 'Propósito y alcance',
        paragraphs: [
          'Esta política explica cómo Pocket Genes conserva, elimina, desidentifica o preserva información en cuentas, integraciones, autorizaciones, documentos de proveedor, acceso a informes, comunidad, soporte, logs y backups.',
      ...
      {
        heading: 'Registros de decisión y autorización',
        paragraphs: [
          'Los registros de decisión y autorización pueden sobrevivir a datos temporales de contacto porque Pocket Genes puede necesitar evidencia de decisión, versión de documento o pantalla, flujo, fecha y proveedor u organización. Esto es distinto de conservar un informe completo o información de invitación innecesaria.',
