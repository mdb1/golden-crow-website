...
// RosterTable.tsx — interactive client roster table (P11-05).
//
...
//
// 11-06 will extend this file with a "Needs attention" filter chip
// toolbar + a per-row AlertCircle icon for clients flagged by the
// `clientNeedsAttention` predicate.
