// ClientIdentityEditor.tsx — the coach's private nickname for a client, plus
// the app-owned birthday shown read-only.
//
// The card wrapper is gone: this now renders as bare fields inside
// ClientSettingsDialog. It kept a full-width slot on the profile for a field
// edited once per client, which is what the dialog is for.
