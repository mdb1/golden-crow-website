  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHero
        eyebrow="Areas"
        title="Create doctor"
        description="Create a doctor record tied to one institution. The rest of the doctor setup happens after the record exists."
      />
      <HelperBanner title="Pick the institution once, then manage from doctor detail." tone="blue">
