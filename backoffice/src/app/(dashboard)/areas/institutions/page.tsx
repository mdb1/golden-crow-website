  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <HelperBanner title={t("Institution scope is the root of the new areas model.")} tone="blue">
        {t("Every institution-scoped role, doctor, and patient record hangs off one institution. Full admins can create new institutions; institution admins and doctors stay inside their single institution boundary.")}
      </HelperBanner>
      <AreaAccessEntry
