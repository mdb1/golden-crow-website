  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHero
        ...
        description={t("Email-based role assignments with a clear hierarchy: full admin, institution admin, institution operator, institution laboratory staff, institution doctor, and patient.")}
      />
