  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <HelperBanner title="Changing a role changes access boundaries." tone="blue">
        Use this screen to adjust role power deliberately. The backend prevents
        cross-institution leakage and stops doctors from assigning anything
        outside their patient scope.
      </HelperBanner>
      {optionsUnavailable ? (
        <HelperBanner title="Some linked option lists could not be loaded." tone="amber">
          The role record is open, but one or more institution, doctor, or
          patient selector lists failed to load. Refresh after the SDK data
          source recovers.
        </HelperBanner>
      ) : null}
      <RoleWorkbench
