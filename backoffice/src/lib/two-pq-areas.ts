...
export const TWO_PQ_AREA_CONFIGS: TwoPQAreaConfig[] = [
  ...
  },
  {
    key: "clients",
    label: "2PQ Clients",
    navLabel: "2PQ Clients",
    route: "/2pq-dashboard/clients",
    collectionKey: "2pq_client",
    icon: Users,
    tone: "slate",
    description:
      "Client and access-facing records stored in Firebase under `2pq_client`.",
    summary:
      "Use this area for client contact state, communication status, preferred language, and role-linked access visibility.",
    helperTitle: "Client access records are now editable documents.",
    helperBody:
      "These records let operators manage real client-facing state while keeping institution, doctor, patient, and role links visible.",
    searchPlaceholder: "Search clients by name, email, phone, language, country, role email, or communication status...",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        description: "Primary client contact fields.",
        fields: [
          {
            key: "clientName",
            label: "Client name",
            ...
            description: "Client-facing name.",
          },
          {
            key: "clientEmail",
            label: "Client email",
          ...
          },
          {
            ...
            description: "Primary client phone.",
          },
          {
        ...
        fields: [
          {
            ...
            description: "Backoffice role email associated with this client lane.",
          },
          {
            key: "accessStatus",
            label: "Access status",
            ...
            description: "Client access status.",
          },
          {
            ...
            description: "Communication state with the client.",
          },
          {
            key: "notes",
            label: "Notes",
