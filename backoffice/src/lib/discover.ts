...
export const DISCOVER_FEED_TYPE_DEFINITIONS: readonly DiscoverFeedTypeDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "regionalStartTimes", label: "Regional start times", kind: "string" },
      { key: "regionalEndTimes", label: "Regional end times", kind: "string" },
      { key: "regionalTimezones", label: "Regional timezones", kind: "string" },
