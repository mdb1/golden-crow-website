...
export const DISCOVER_FEED_TYPE_DEFINITIONS: readonly DiscoverFeedTypeDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "dailyStartTime", label: "Daily start time", kind: "string" },
      { key: "dailyEndTime", label: "Daily end time", kind: "string" },
      { key: "multiDayLength", label: "Multi-day length", kind: "integer" },
      { key: "countryDailyStartTimes", label: "Country start times", kind: "string" },
      { key: "countryDailyEndTimes", label: "Country end times", kind: "string" },
      { key: "countryTimezones", label: "Country timezones", kind: "string" },
      { key: "eventKind", label: "Event kind", kind: "string" },
      { key: "attendanceMode", label: "Attendance mode", kind: "string" },
      { key: "eventStatus", label: "Event status", kind: "string" },
      ...
      { key: "priceMinorUnits", label: "Price in minor units", kind: "integer" },
      { key: "languages", label: "Languages", kind: "array" },
      { key: "accessibilityFeatures", label: "Accessibility features", kind: "array" },
    ],
  },
  {
    value: "opportunity",
