...
const SPANISH_TEXT: Record<string, string> = {
  ...
  "Search report categories": "Buscar categorías de reporte",
  "report category selected": "categoría de reporte seleccionada",
  "report categories selected": "categorías de reporte seleccionadas",
  ...
  Prenatal: "Prenatal",
  "Nutrition and metabolism": "Nutrición y metabolismo",
  ...
  "Default text color": "Color de texto predeterminado",
  Ink: "Tinta",
  Purple: "Violeta",
  Blue: "Azul",
  Green: "Verde",
  ...
  "Soft yellow": "Amarillo suave",
  "Soft green": "Verde suave",
  "Soft blue": "Azul suave",
  "Soft purple": "Violeta suave",
  ...
  "Add row before": "Agregar fila antes",
  "Add row after": "Agregar fila después",
  ...
  "Simple text and HTML body are saved separately.":
    "El texto simple y el HTML se guardan por separado.",
  "HTML body and simple text are saved separately.":
    "El HTML y el texto simple se guardan por separado.",
  ...
  "Add optional buttons for registration, live access, agenda, recordings, materials, or organizer contact.":
    "Agregá botones opcionales para registro, acceso en vivo, agenda, grabaciones, materiales o contacto con el organizador.",
  ...
  "The event date is required and sets the starting day for multi-day events.":
    "La fecha del evento es obligatoria y define el primer día en eventos de varios días.",
  "Main event link": "Enlace principal del evento",
  "The main button can stay as the primary event link. Optional actions can add more specific next steps.":
    "El botón principal puede quedar como enlace principal del evento. Las acciones opcionales pueden sumar próximos pasos más específicos.",
  "For all-day events, readers see the date without daily start or end times.":
    "En eventos de día completo, los lectores ven la fecha sin horarios diarios de inicio o fin.",
  "Date-only event": "Evento solo con fecha",
  "Date-only events should be published without a time row, even if daily times are filled.":
    "Los eventos solo con fecha deberían publicarse sin una fila de horario, aunque los horarios diarios estén completos.",
  "Time pending": "Horario pendiente",
  "Use this when the date is known but the time is not ready to publish.":
    "Usá esto cuando la fecha ya esté definida pero el horario todavía no esté listo para publicar.",
  ...
  "Edit a Pocket Genes pgs_* service definition.":
    "Editar una definición de servicio Pocket Genes pgs_*.",
  "Pocket Genes service catalog offers.":
  ...
  "Add input slot": "Agregar slot de entrada",
  ...
  Boolean: "Booleano",
  "Calculated after submission": "Calculado después del envío",
  "Calculated short contract": "Contrato corto calculado",
  ...
  "Help info": "Información de ayuda",
  "Help info text": "Texto informativo de ayuda",
  "Optional guidance shown from the field info button.":
    "Guía opcional que se muestra desde el botón de información del campo.",
  "Define the object produced or revised by this service offer.":
    "Definí el objeto producido o revisado por esta oferta de servicio.",
  "Delete this service offer?": "¿Eliminar esta oferta de servicio?",
  ...
  Enabled: "Habilitado",
  Enum: "Enum",
  "Enum fields need at least one option.":
    "Los campos enum necesitan al menos una opción.",
  "Field key and label are required.":
    "La clave y la etiqueta del campo son obligatorias.",
  ...
  "Only one form input slot is allowed.":
    "Solo se permite un slot de entrada de formulario.",
  ...
  "Select a Discover publisher record for this service offer.":
  ...
  "Clipboard copy failed. You can still select the JSON and copy it manually.":
    "No se pudo copiar al portapapeles. Igual podés seleccionar el JSON y copiarlo manualmente.",
  lines: "líneas",
  Slots: "Slots",
  ...
  Submitted: "Enviado",
  "Support form input": "Soportar entrada de formulario",
  ...
  bound: "vinculado",
  fields: "campos",
  "missing active offer": "oferta activa no encontrada",
