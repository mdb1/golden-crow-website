...
export function BookingsTable() {
  ...
  if (error) return <p className="text-sm text-destructive">Failed to load bookings.</p>;
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {bookings.length === 0 && (
            <tr><td colSpan={4} className="py-4 text-muted-foreground">No bookings found.</td></tr>
          )}
