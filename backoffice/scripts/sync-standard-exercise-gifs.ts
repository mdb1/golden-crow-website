...
const OVERRIDES: Record<string, string | null> = {
  ...
  // Issue #307 — warm-up & stretching additions. Mapped to wger/free gif assets
  // by id; null = no good asset, ship without a gif (SF-Symbol fallback on device).
  "Rear Deltoid Stretch (Bodyweight)": "0669",
  "Triceps Stretch (Bodyweight)": "0817",
  "Overhead Triceps Stretch (Bodyweight)": "0643",
  "Neck Side Stretch (Bodyweight)": "1403",
  "Seated Glute Stretch (Bodyweight)": "1424",
  "Seated Piriformis Stretch (Bodyweight)": "2567",
  "Runners Stretch (Bodyweight)": "1585",
  "Calf Stretch (Bodyweight)": "1398",
  "Kneeling Lat Stretch (Bodyweight)": "1346",
  "Spine Stretch (Bodyweight)": "1363",
  "Upper Back Stretch (Bodyweight)": "1365",
  "Seated Lower Back Stretch (Bodyweight)": "0690",
  "Standing Lateral Stretch (Bodyweight)": "0794",
  "Butterfly Stretch (Bodyweight)": "1494",
  "Side Wrist Stretch (Bodyweight)": "0721",
  "Full Body Stretch (Bodyweight)": null,
  "High Knees (Bodyweight)": "3636",
  "Mountain Climber (Bodyweight)": "0630",
  "Jump Rope (Rope)": "2612",
  ...
  "Warm-up Shoulders (Bodyweight)": null,
  "Warm-up Legs (Bodyweight)": null,
  "Warm-up Hips (Bodyweight)": null,
  "Warm-up Back (Bodyweight)": null,
  "Warm-up Arms (Bodyweight)": null,
  "Warm-up Core (Bodyweight)": null,
};
